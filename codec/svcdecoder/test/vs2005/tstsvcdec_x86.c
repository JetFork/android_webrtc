...
int main()
{
	...
	ConfigPar.debugfp = fopen("layer0.stream","wb");
	GVE_SVC_Decoder_SetDebugFile(GVE_SVCDec_Handle,&OperatePar,&ConfigPar,&OutPutInfo);
	ConfigPar.debugflag = 1;
	ConfigPar.debuglayer = 1;
	ConfigPar.debugfp = fopen("layer1.stream","wb");
	GVE_SVC_Decoder_SetDebugFile(GVE_SVCDec_Handle,&OperatePar,&ConfigPar,&OutPutInfo);
	ConfigPar.debugflag = 1;
	ConfigPar.debuglayer = 2;
	ConfigPar.debugfp = fopen("layer2.stream","wb");
	GVE_SVC_Decoder_SetDebugFile(GVE_SVCDec_Handle,&OperatePar,&ConfigPar,&OutPutInfo);
