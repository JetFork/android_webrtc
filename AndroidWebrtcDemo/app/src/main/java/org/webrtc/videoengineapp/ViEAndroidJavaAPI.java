...
public class ViEAndroidJavaAPI {
    ...
    public native int RegisterSendTransport(boolean useExternal, boolean useSVCServer);
    // Codec
    ...
    public native int SetRenderType(int channel, int ScaleType);
    
    public native int StartPlayFlvFile(Object glSurface);
    
    //snapshot
    public native int SnapLocal(int cameraId, String filename);
    public native int SnapRemote(int channel, String filename);
    public native int SetCaptureFlashlight(int channel, boolean on);
    ...
    public native boolean VoE_Create(Context context, int callBack);
    public native boolean VoE_Delete();

    // VoiceEngineObserver
    public native int VoE_RegisterVoiceEngineObserver();
    public native int VoE_DeRegisterVoiceEngineObserver();
    ...
    // Media functions
    public native int VoE_RegisterExternalTransport(int channel);
    public native int VoE_DeRegisterExternalTransport(int channel);
    ...
    public native int VoE_PlayAudio(int channel, int data, int len);

    // Volume
    public native int VoE_SetSpeakerVolume(int volume);
    public native boolean VoE_GetInputMute();
    public native int VoE_SetInputMute(boolean enable);
    
    // Hardware
    public native boolean VoE_GetLoudspeakerStatus();
    public native int VoE_SetLoudspeakerStatus(boolean enable);
    public native int VoE_SetRecordingDevice(int index);
    public native int VoE_SetChannelOutputVolumeScaling(int channel, float volume);
    ...
    public native int VoE_GetSendCodec(int channel);
    ...
    public native int VoE_SetVADStatus(int channel, boolean enable, int mode, boolean disableDTX);
