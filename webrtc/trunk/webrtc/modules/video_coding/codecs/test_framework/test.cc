...
CodecTest::Print()
{
    ...
    I420PSNRFromFiles(_inname.c_str(), _outname.c_str(), _inst.width_used,
                      _inst.height_used, &psnr);
    I420SSIMFromFiles(_inname.c_str(), _outname.c_str(), _inst.width_used,
                      _inst.height_used, &ssim);
...
CodecTest::Setup()
{
    _width = _inst.width_used;
    _halfWidth = (_width + 1) / 2;
    _height = _inst.height_used;
                         ...
                         WebRtc_UWord32 bitRate /*=0*/)
{
    ...
    _inst.width_used = width;
    _inst.height_used = height;
}
