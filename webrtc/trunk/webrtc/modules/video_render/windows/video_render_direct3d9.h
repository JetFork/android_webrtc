...
public:
    D3D9Channel(LPDIRECT3DDEVICE9 pd3DDevice,
                    CriticalSectionWrapper* critSect, Trace* trace,EventWrapper* UpdateScreenEvent);
...
private:
	...
	EventWrapper* _UpdateScreen_Event; //added by wuzhong 20140211
...
private:
    ...
    float _logoRight;
    float _logoBottom;
	IDirect3D9Ex *pD3DEx;//GXH_TEST_H264
	float _offsetrender;
