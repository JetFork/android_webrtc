...
public:
	...
	virtual WebRtc_Word32 SetCaptureFlashlight(bool on){ return 0;}
...
//#ifdef WEBRTC_IOS
   void SetResampleResolution(int width,int height);
//#endif
	virtual WebRtc_Word32 SetIsCapture4_3(int isCapture4_3)
	{
		m_bCapture4_3 = isCapture4_3;
		return 0;
	}
protected:
