    ...
    const bool videoOnly /*= false*/)
{
    ...
    videoStreamHeader.dwSuggestedBufferSize  = videoCodecInst.height_used *
        (videoCodecInst.width_used >> 1) * 3;
    videoStreamHeader.dwQuality              = (WebRtc_UWord32)-1;
    videoStreamHeader.dwSampleSize           = 0;
    videoStreamHeader.rcFrame.top            = 0;
    videoStreamHeader.rcFrame.bottom         = videoCodecInst.height_used;
    videoStreamHeader.rcFrame.left           = 0;
    videoStreamHeader.rcFrame.right          = videoCodecInst.width_used;

    BITMAPINFOHEADER bitMapInfoHeader;
    bitMapInfoHeader.biSize         = sizeof(BITMAPINFOHEADER);
    bitMapInfoHeader.biHeight       = videoCodecInst.height_used;
    bitMapInfoHeader.biWidth        = videoCodecInst.width_used;
                                                ...
                                                bool videoOnly, bool loop)
{
    ...
    _videoCodec.width_used = static_cast<WebRtc_UWord16>(
        videoInStreamHeader.rcFrame.right);
    _videoCodec.height_used = static_cast<WebRtc_UWord16>(
    ...
    if (bitmapInfo.biCompression == AviFile::MakeFourCc('I','4','2','0'))
    {
       ...
       _videoCodec.codecType = kVideoCodecI420;
             ...
             AviFile::MakeFourCc('S', 'V', 'C', '0'))
    {
        strncpy(_videoCodec.plName, "SVC", plnameLen);
        _videoCodec.codecType = kVideoCodecSVC;
    }
#endif
    else if (bitmapInfo.biCompression ==
