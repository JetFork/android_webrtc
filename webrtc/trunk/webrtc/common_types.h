...
extern void* globalAudioScClass;
extern void* globalVideoScCmClass;
extern void* globalVideoScCmDevInfoClass; 
extern void* globalVideoScjavaCmCapabilityClass;
extern void* globalVideoScRenderClass;
...
struct VideoCodec
{
	...
	int h264SubType;  //0 baseline  1,mainprofile  2 high profile  only support three types  for extension later

	unsigned short  widthAlloc;

	unsigned short 	heightAlloc;

    unsigned short      width_used;
    unsigned short      height_used;




	unsigned int bitrates[3];
	unsigned int startBitrate;
	unsigned int maxBitrate;
	unsigned int minBitrate;
	unsigned char maxFramerate;

	unsigned int encLevel;
	unsigned int enclayer;
...
typedef void (*DecodedDataCallback)(void * YBuf,void * Ubuf,void *Vbuf, int width, int height);
