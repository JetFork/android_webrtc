...
void Trace::Add(const TraceLevel level, const TraceModule module,
  ...
  //kmm add for debug video
  if ((module == kTraceVoice) || (module == kTraceAudioCoding) || (module == kTraceAudioMixerServer) ||
	  (module == kTraceAudioMixerClient) || (module == kTraceAudioProcessing) || (module == kTraceAudioDevice))
  {
	  trace = NULL;
  }
  //kmm add end
