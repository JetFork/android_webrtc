                                        ...
                                        WebRtc_UWord32 /*maxPayloadSize */)
{
    ...
    const WebRtc_UWord32 newSize = (3 * inst->width_used * inst->height_used) >> 1;
                                        ...
                                        WebRtc_Word32 /*numberOfCores */)
{
    ...
    else if (inst->width_used < 1 || inst->height_used < 1)
    {
        return WEBRTC_VIDEO_CODEC_ERR_PARAMETER;
    }
    _width = inst->width_used;
    _height = inst->height_used;
