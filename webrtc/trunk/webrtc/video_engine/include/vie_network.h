...
//  - Dead live connection observations.
...
class ViENetworkObserver {
 public:
  // This method will be called periodically delivering a dead live
...
class  ViENetwork {
 public:
  ...
  // Factory for the ViENetwork API and increases an internal reference
  ...
  // This function sets the six it Differentiated Services Code Point (DSCP)
  ...
  // Retrieves the six t Differentiated Services Code Point (DSCP) in the IP
  ...
  // This function enables or disables the periodic dead live callback
