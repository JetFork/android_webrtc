...
// device.
/** 
* @brief		This structure describes one set of the supported capabilities for a capture device.
*
*/
...
class  ViECapture {
 public:
  ...
  virtual int SetCaptureFlashlight(const int capture_id, const bool on) = 0;
