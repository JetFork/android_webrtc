...
#ifndef WEBRTC_VIDEO_ENGINE_VIE_VIRTUAL_FILE_PLAYER_H_
#define WEBRTC_VIDEO_ENGINE_VIE_VIRTUAL_FILE_PLAYER_H_
...
public:
 ...
 static ViEVirtualFilePlayer* CreateViEVirtualFilePlayer(int file_id,
                                            int engine_id,
...
*/
 ...
 protected:
  ViEVirtualFilePlayer(int Id, int engine_id);
...
/*
  //创建命名管道
  void CreateNamePipeInServer();

  //打开命名管道
  void OpenNamePipeInClient();
*/
