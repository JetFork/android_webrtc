...
LOCAL_MODULE    := libamr
#LOCAL_STATIC_LIBRARIES := libamr.a
LOCAL_CFLAGS = -DFIXED_POINT -DUSE_KISS_FFT -DEXPORT="" -UHAVE_CONFIG_H
LOCAL_C_INCLUDES := $(LOCAL_PATH)/oscl
LOCAL_C_INCLUDES += $(LOCAL_PATH)/m4
LOCAL_C_INCLUDES += $(LOCAL_PATH)/opencore/codecs_v2/audio/gsm_amr/common/dec/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/opencore/codecs_v2/audio/gsm_amr/amr_nb/common/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/opencore/codecs_v2/audio/gsm_amr/amr_nb/enc/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/opencore/codecs_v2/audio/gsm_amr/amr_nb/enc/src
LOCAL_C_INCLUDES += $(LOCAL_PATH)/opencore/codecs_v2/audio/gsm_amr/amr_nb/dec/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/opencore/codecs_v2/audio/gsm_amr/amr_nb/dec/src
LOCAL_C_INCLUDES += $(LOCAL_PATH)/opencore/codecs_v2/audio/gsm_amr/amr_wb/dec/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/opencore/codecs_v2/audio/gsm_amr/amr_wb/dec/src
LOCAL_C_INCLUDES += $(LOCAL_PATH)/amrnb
LOCAL_C_INCLUDES += $(LOCAL_PATH)/amrwb
